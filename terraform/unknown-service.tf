...
output "unknown_service-public-address" {
  value = "${module.unknown_service.public_ip}"
}

output "unknown_service-ssh" {
  value = "ssh -i keys/deployer centos@${module.unknown_service.public_ip}"
}
